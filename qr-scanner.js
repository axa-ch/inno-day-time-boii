class e {
  ...
  constructor(
    a,
    b,
    c = this._onDecodeError.bind(this),
    d = e.DEFAULT_CANVAS_SIZE,
    f = 'environment'
  ) {
    this.$video = a;
    ...
    this._sourceRect = { x: 0, y: 0, width: d, height: d };
  ...
  static scanImage(a, b = null, c = null, d = null, f = !1, k = !1) {
    let g = c instanceof Worker,
      h = Promise.all([c || e.createQrEngine(), e._loadImage(a)]).then(
        ([a, h]) => {
          c = a;
          let k;
          [d, k] = this._drawToCanvas(h, b, d, f);
          return c instanceof Worker
            ? (g || c.postMessage({ type: 'inversionMode', data: 'both' }),
              new Promise((a, b) => {
                let f, l, g;
                l = (d) => {
    ...
    b && k && (h = h.catch(() => e.scanImage(a, null, c, d, f)));
    return (h = h.finally(() => {
      g || e._postWorkerMessage(c, 'close');
    }));
  }
    ...
    requestAnimationFrame(() => {
      1 >= this.$video.readyState
        ...
        : this._qrEnginePromise
            .then((a) =>
              e.scanImage(this.$video, this._sourceRect, a, this.$canvas, !0)
            )
  ...
  static _drawToCanvas(a, b = null, c = null, d = !1) {
    ...
    let f = b && b.x ? b.x : 0,
      k = b && b.y ? b.y : 0,
      g = b && b.width ? b.width : a.width || a.videoWidth;
    b = b && b.height ? b.height : a.height || a.videoHeight;
    d || (c.width === g && c.height === b) || ((c.width = g), (c.height = b));
    d = c.getContext('2d', { alpha: !1 });
    d.imageSmoothingEnabled = !1;
    d.drawImage(a, f, k, g, b, 0, 0, c.width, c.height);
    return [c, d];
  }
  static _loadImage(a) {
    if (
